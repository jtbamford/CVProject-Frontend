		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="/trainee/CV">My
							CV's</a></li>
					<li class="nav-item"><a class="nav-link"
						href="trainee/account">My Account</a></li>
				</ul>
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="/homepage">Home <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link"
						href="/trainer/trainerpage">My Account</a></li>
					<li class="nav-item"><a class="nav-link" href="/trainer/CV">CVs</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="/trainer/viewtrainees" onClick()="view()">Trainees</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li class="nav-item"><a class="nav-link"
						href="<c:url value="/perform_logout" />">Logout</a></li>
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="/homepage">Home <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link"
						href="/trainingmanager/adminpage">My Account</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/trainingmanager/CV" onClick()="view1()">CVs</a>
					<li class="nav-item dropdown">
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#"
						id="navbarDropdownMenuLink" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> Trainees </a>
						<div class="dropdown-menu"
							aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item"
								href="/trainingmanager/trainees/viewtrainees" >View</a>
							<a class="dropdown-item"
								href="/trainingmanager/trainees/addtrainees">Add</a> <a
								class="dropdown-item"
								href="/trainingmanager/trainees/edittrainees">Amend</a>

						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#"
						id="navbarDropdownMenuLink" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> Trainers </a>
						<div class="dropdown-menu"
							aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item"
								href="/trainingmanager/trainers/viewtrainers">View</a> <a
								class="dropdown-item"
								href="/trainingmanager/trainers/addtrainers">Add</a> <a
								class="dropdown-item"
								href="/trainingmanager/trainers/edittrainers">Amend</a>
						</div></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li class="nav-item"><a class="nav-link"
...
<script>
  view1 = function() {
    ...
    var data = "{\"username\": \"manager\",\"password\": \"12347\"}";
